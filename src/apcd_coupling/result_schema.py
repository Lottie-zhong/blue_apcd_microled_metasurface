...
def validate_result(result: dict[str, Any]) -> dict[str, Any]:
    ...
    for key in ("R_total", "T_total", "eta_plus1", "eta_zero", "eta_minus1", "theta_out_plus1_deg", "directionality"):
