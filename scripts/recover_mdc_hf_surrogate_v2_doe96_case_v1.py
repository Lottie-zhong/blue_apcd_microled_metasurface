...
import run_mdc_hf_surrogate_v2_doe96_joint_profile_v1 as runner
...
with (run_root/'doe96_case_attempt_ledger.jsonl').open('a',encoding='utf-8') as lf: lf.write(json.dumps({'case_id':case_id,'geometry_hash':case['geometry_hash'],'case_hash':case['case_hash'],'attempt_id':recovery_id,'solver_entered':False,'recovery_type':'post_fsp_extraction_only','source_solver_attempt_id':attempt_id,'post_fsp_sha256':fsp_sha,'timestamp':now()},sort_keys=True)+'\n')
