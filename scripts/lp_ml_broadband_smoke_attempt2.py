...
ECONTRACT=ROOT/'outputs/lp_ml_dataset_v1/plans/lp_ml_dataset_v1_broadband_smoke_attempt2_execution_contract_v1.json'
ATTEMPT_ID='LP_ML_ROUND1_SMOKE_ATTEMPT2_V1'
STAGE=ROOT/'outputs/lp_ml_dataset_v1/staging/lp_ml_dataset_v1_round1_smoke_attempt2_v1'
TMP=Path(tempfile.gettempdir())/'lp_ml_dataset_v1_round1_smoke_attempt2_runtime'
