...
def main():
 ...
 ts=sum(x['power_fraction_of_source'] for x in transmitted); rs=sum(x['power_fraction_of_source'] for x in reflected); bt={x['m']:x for x in transmitted}; group=case['control_group']; applicable=group in {'B2','B3'}
