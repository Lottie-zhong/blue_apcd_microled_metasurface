...
GENERATOR = 'NP_K6_PILOT_FDTD_GENERATOR_FIXED_GRID_V1'
MESH_ID = 'NP_K6_PILOT_FIXED_GRID_V1'
SOURCE = ROOT / 'outputs/np_k6_hf_pilot_gate0_n2_production_mesh_v1_corrected_monitor_contract_v1' / 'BROADBAND_PARETO_K6X_FIXED_NESTED_N2_WITH_N1_DIAGNOSTIC_MONITORS.fsp'
CASES = [
    ('RUN3C_P_PILOT_HF_V1', 'RUN3C', 'p', [130, 145, 155, 180, 195, 230]),
    ('RUN3C_S_PILOT_HF_V1', 'RUN3C', 's', [130, 145, 155, 180, 195, 230]),
    ('RUN3A_P_PILOT_HF_V1', 'RUN3A', 'p', [125, 135, 150, 175, 190, 210]),
    ('RUN3A_S_PILOT_HF_V1', 'RUN3A', 's', [125, 135, 150, 175, 190, 210]),
    ('RUN3B_P_PILOT_HF_V1', 'RUN3B', 'p', [100, 115, 130, 145, 155, 185]),
    ('RUN3B_S_PILOT_HF_V1', 'RUN3B', 's', [100, 115, 130, 145, 155, 185]),
]
...
def main():
    ...
    root_manifest = {
        'stage': 'NP_K6_HF_P0_LABEL_GENERATOR_RECOVERY_AND_ANCHOR_ACQUISITION_V1',
        ...
        'created_utc': datetime.now(timezone.utc).isoformat(), 'schema_version': 'np_k6_hf_p0_pilot_generator_manifest_v1',
    }
