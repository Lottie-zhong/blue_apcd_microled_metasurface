...
CONTRACTS = [
    ML / "plans/b120_j2lm06_stage_d7_execution_contract_v1.json",
    ML / "plans/b120_j2lm06_stage_d7_ml_label_contract_v1.json",
    ML / "plans/b120_j2lm06_stage_d7_validation_metric_contract_v1.json",
]
...
FORMAL_STAGING = ML / "staging/b120_j2lm06_stage_d7_five_variable_trust_region_validation_v1"
SCRIPT = ROOT / "scripts/lp_b120_j2lm06_stage_d7_trust_region_execute_v1.py"
RUNTIME = ROOT / "scripts/lp_checkpoint_authoritative_runtime_v1_23.py"
PARENT_HEAD = "57679e27bb4f72c154d60d909fa193ff87effe5d"
...
EXPECTED_CANDIDATES = [
    "D7_TRV_PROP_ac2e5d6ca24e9987", "D7_TRV_PROP_00098aaf5db983b9",
    "D7_TRV_PROP_f5fdd16c144945e5", "D7_TRV_PROP_27a9f273b1daf877",
    "D7_TRV_PROP_89eb19e02e4961be", "D7_TRV_PROP_5faf242ac18ec85b",
    "D7_TRV_PROP_693ec7d86d7c23e2", "D7_TRV_PROP_56364757e6cc98ca",
]
...
def expected_identity(candidate: dict, polarization: str) -> dict:
    ...
    return {"candidate_id": candidate["candidate_id"], "input_polarization": polarization, "wavelength_nm": 450.0,
            ...
            "source_plan_sha256": sha(PLAN), "schema_version": "LP_ML_SCHEMA_V1.23"}
...
if __name__ == "__main__":
    # Redirect the D6 adapter's globals to the independently attested D7 inputs.
