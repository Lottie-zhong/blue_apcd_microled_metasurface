...
PLAN=ML/"plans/b120_j2lm06_post_d8_local_curvature_diagnostic_plan_v1.json"
CONTRACTS=[ML/"plans/b120_j2lm06_post_d8_local_curvature_execution_contract_v1.json",ML/"plans/b120_j2lm06_post_d8_local_curvature_ml_label_contract_v1.json",ML/"plans/b120_j2lm06_post_d8_local_curvature_validation_metric_contract_v1.json"]
PACKAGE=ML/"execution_packages/b120_j2lm06_post_d8_local_curvature_diagnostic_execution_package_v1"
STAGING=ML/"staging/b120_j2lm06_post_d8_local_curvature_diagnostic_v1"
...
EXPECTED_HEAD="d2d427bc9fe8c43fac67bb9b93aef094f0a32662"
...
def prepare():
 ...
 m={"status":"READY_FOR_EXPLICIT_EXECUTION","plan_version":"POST_D8_LOCAL_CURVATURE_DIAGNOSTIC_PLAN_V1","candidate_order":a["candidate_order"],"subrun_order":a["subrun_order"],"future_budget":a["future_budget"],"source_hashes":a["source_hashes"],"anchor":"D8_TRV_PLAN_d6f4911593b64495","design":"A_ANTIPODAL_TETRAHEDRAL_COMPLEMENT","no_d9":True,"no_extra_probe":True}
...
def main():
 ...
 if git("rev-parse","HEAD")!=EXPECTED_HEAD: raise RuntimeError("FROZEN_HEAD_MISMATCH")
...
if __name__=="__main__":
 d6.PLAN=PLAN;d6.CONTRACTS=CONTRACTS;d6.PACKAGE=PACKAGE;d6.FORMAL_STAGING=STAGING;d6.SCRIPT=SCRIPT;d6.RUNTIME=RUNTIME;d6.PARENT_HEAD=git("rev-parse","HEAD^");d6.plan_spec=plan_spec;d6.expected_identity=expected_identity;d6.runtime_attestation=attestation;d6.load_runtime=load_runtime
