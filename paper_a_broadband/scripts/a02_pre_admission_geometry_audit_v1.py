...
def main():
    ...
    out={
      ...
      'interpretation':{'reported_canonical_min_edge_gap_nm':g['validity']['min_edge_gap_nm'],'reported_value_definition':'aggregate of polygon pair distances and cell-boundary clearances; field name is not a pure pillar-to-pillar edge gap','reported_value_source':f"{boundary_min['object']} vertex {boundary_min['vertex_index']} to bottom cell boundary y=-216 nm",'reported_pair_is_same_cell':False,'reported_pair_is_periodic_image':False,'independent_same_cell_pillar_pair_gap_nm':same_min['distance_nm'],'independent_periodic_seam_gap_nm':fmt(seam_gap),'classification':'REPORTING_DEFINITION_ARTIFACT_REVEALS_GENUINE_PERIODIC_SEAM_NEAR_CONTACT','pre_admission_status':'PRE_ADMISSION_GEOMETRY_RISK'},
