...
The reported 0.032 nm is not the pillar-1/pillar-2 edge gap. It is the distance from pillar_2 vertex 0 to the lower periodic cell boundary y=-216 nm: `0.031995530124988964860678346652 nm`. The implied same-object periodic seam gap is `0.063991060249977929721356693304 nm`.

Same-cell pillar_1/pillar_2 minimum edge gap: `44.5319955301249939648606783467 nm`, between the pillar_2 closest vertex and the bottom edge of pillar_1 at x approximately `9.0747172360105242120507084472 nm`.
