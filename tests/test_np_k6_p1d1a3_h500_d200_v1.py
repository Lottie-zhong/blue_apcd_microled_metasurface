...
def test_d200_and_spectral_readiness():
 ...
 assert c['wavelength_grid_nm']==list(range(445,456)) and c['dense_diameter_grid_nm']==list(range(100,231,5)) and c['selected_height_nm'] is None and c['P1D2_SOLVER_RELEASE'] is False
